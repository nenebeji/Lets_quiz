...
* * Intro.html: to store the first page with instructions and start quiz button.
* * Index.html: the main file that contained the quiz and end page for initials.
...
* * intro.css: has the base styles for all the pages, linked to index and intro html
* * style.css: linked to just the index.html.
* * highscore.css: linked to just the highscore.html file.

* Also creasted two Js files:
* * script.js: linked index.html file.
